              ...
              child: Column(
                children: [
                  ...
                  GetBuilder<ModifiedProductController>(
                      builder: (_) => AddProductExpansionListField(
                            onTap: () => controller.nextBtnFill(),
                            hintText: controller.category,
                            items: controller.categoryList!,
                            onChange: (value) =>
                                controller.hintText(value, "category"),
                            idxChange: (value) =>
                  ...
                  GetBuilder<ModifiedProductController>(
                      builder: (_) => AddProductExpansionListField(
                            ...
                            onChange: (value) =>
                                controller.hintText(value, "brand"),
                            idxChange: (value) =>
                                controller.changeBrandCategory(value),
                            hintIdx: (value) {},
                          )),
                  const SizedBox(height: 16),
                  FormInputTitleRowWidget(
                  ...
                  FormInputTitleRowWidget(
                    ...
                    onChange: (value) {
                      ...
                      if(value.length > 0) {
                        ...
                        controller.buyPriceCtrl.value = TextEditingValue(
                          text: value,
