...
class ShopAddProductPage extends GetView<ShopAddProductController> {
  ...
  _photoApply() {
    return GetBuilder<ShopAddProductController>(
  ...
  _futureBody(BuildContext context) {
    return Obx(
      () => controller.runningServer.value
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  GetBuilder<ShopAddProductController>(
                      builder: (_) => AddShopExpansionListField(
                            onTap: () {},
                            hintText: controller.myProductIdx == null
                                ? "등록된 제품을 선택해주세요"
                                : controller
                                    .myProductList[controller.currentIdx!]
                                    .title,
                            items: controller.myProductList,
                            onChange: (value) =>
                                controller.currentListIdx(value),
                            idxChange: (value) =>
                                controller.changeProductIdx(value),
                        ...
                        children: [
                          ...
                          if (controller.myProductIdx != null)
                            GestureDetector(
                              ...
                              onTap: () {
                                Get.toNamed(
                                    '/main/my/change_product/history/product/info',
      ...
      Container(
        ...
        child: Column(
          children: <Widget>[
            ListTile(
              onTap: () async =>
                  await controller.loadAssets(ImageSource.camera),
              title: Text(
                "직접 촬영",
            ...
            ListTile(
              onTap: () async =>
                  await controller.loadAssets(ImageSource.gallery),
              title: Text(
                "갤러리에서 사진 선택",
                style: medium14TextStyle,
              ),
