...
class ShopModifiedPage extends GetView<ShopModifiedController> {
  ...
  _photoApply() {
    return GetBuilder<ShopModifiedController>(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "${shopDetailController.model?.title ?? "로딩중"}",
                    style: medium16TextStyle,
                  ),
                  const SizedBox(height: 8),
                  Row(
                    children: <Widget>[
                      Text("${shopDetailController.model?.brand ?? "로딩중"}",
                          style: regular12TextStyle.copyWith(
                              color: gray_999Color)),
                      const SizedBox(width: 8),
                      VerticalDivider(width: 1, color: Color(0xff999999)),
                      const SizedBox(width: 8),
                      Text("${shopDetailController.model?.category ?? "로딩중"}",
                          style: regular12TextStyle.copyWith(
                              color: gray_999Color)),
                      const SizedBox(width: 8),
                      VerticalDivider(width: 1, color: Color(0xff999999)),
                      ...
                      Text(
                        DateFormatUtil.convertDateTimeFormat(
                            date:
                                "${shopDetailController.model?.createdDate ?? "2021-08-31T00:39:24.562773"}"),
                        style:
