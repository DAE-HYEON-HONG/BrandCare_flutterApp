...
class MainShopListMinePage extends StatelessWidget {
  final MainShopListMineController controller =
      Get.put(MainShopListMineController());
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            GetBuilder<MainShopListMineController>(
