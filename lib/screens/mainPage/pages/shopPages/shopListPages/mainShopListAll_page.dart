...
class MainShopListAllPage extends StatelessWidget {
  final MainShopListAllController controller =
      Get.put(MainShopListAllController());
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            GetBuilder<MainShopListAllController>(
