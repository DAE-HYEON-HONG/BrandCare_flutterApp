...
class ChangeProductExpansionListField extends StatefulWidget {
  String hintText;
  final Function onTap;
  final List<ProductModel> items;
  final ValueChanged<int> onChange;
  final ValueChanged<ProductModel> idxChange;
  final ScrollController controller;
  ChangeProductExpansionListField({
    required this.onTap,
  ...
  @override
  _ChangeProductExpansionListFieldState createState() => _ChangeProductExpansionListFieldState();
}

class _ChangeProductExpansionListFieldState extends State<ChangeProductExpansionListField> with SingleTickerProviderStateMixin{
  ...
  void idxChangeValue(ProductModel value){
    print(value);
                        ...
                        itemBuilder: (context, idx) {
                          return GestureDetector(
                            ...
                            onTap: () {
                              ...
                              idxChangeValue(widget.items[idx]);
                              widget.onChange(idx);
                              this.idx = idx;
                            },
                            child: Container(
